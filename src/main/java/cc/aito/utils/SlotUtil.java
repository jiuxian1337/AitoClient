 ...
 */
public class SlotUtil implements Wrapper {
    ...
    public static final List<Block> interactList = Arrays.asList(Blocks.enchanting_table, Blocks.chest, Blocks.ender_chest,
    ...
    public static int findBlock() {
        for (int i = 36; i < 45; i++) {
            ...
            if (item != null && item.getItem() instanceof ItemBlock && item.stackSize > 5) {
